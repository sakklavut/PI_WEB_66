               ...
               <div class="col-xl-3 col-md-3 mt-3">
                    ...
                    <div class="row">
                         <div class="col-xl-12">
                             <div class="d-flex">
                                   ...
                                   <div class="me-2">
                                        <p class="p_footer">
                                             สถาบันพระบรมราชชนก กระทรวงสาธารณสุข อาคาร 4 ชั้น 8 สำนักงานปลัดกระทรวงสาธารณสุข ถนนติวานนท์ตำบลตลาดขวัญ  อำเภอเมือง จังหวัดนนทบุรี 11000
                                        </p>
                                   </div>
                             </div>
                         </div>
                    ...
                    <div class="row">
                         <div class="col-xl-12">
                             <div class="d-flex">
                                   <div class="me-2">
                                        <img src="assets/icon/tem.svg" alt="">
                                   </div>
                                   <div class="me-2">
                                        <p class="p_footer">
                                        ...
                                        <div class="col-xl-6">
                                             <ul class="ul_footer">
                                                  <li class="li_footer">
                                                       <div class="d-flex">
                                                            <div class="me-2">
                                                                 <img src="assets/icon/li.svg" alt="">
                                                            </div>
                                                            <div class="me-2">
                                                                  <p class="p_footer">
